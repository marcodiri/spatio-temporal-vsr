...
class FolderDataset(Dataset):
        ...
        **kwargs,
        ...
        Args
            ...
            rescale_factor (None or float):
                ...
                with 'downscale' parameter of the nets classes.
        """
    ...
    def __getitem__(self, item):
        ...
        hr_pats, lr_pats = self.crop_sequence(hr_frms, lr_frms)
        hr_pats, lr_pats = self.augment_sequence(hr_pats, lr_pats)
    ...
    def augment_sequence(self, gt_pats, lr_pats):
        # flip
